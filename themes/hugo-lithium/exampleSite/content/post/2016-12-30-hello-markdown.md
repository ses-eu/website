...
2. A plain Markdown post is rendered through [Blackfriday](https://gohugo.io/overview/configuration/), and an R Markdown document is compiled by [**rmarkdown**](https://rmarkdown.rstudio.com) and [Pandoc](https://pandoc.org).

(function () {
    function dv() {
        ...
        var crt_aptATFMsesMM = new google.visualization.ChartWrapper({
            ...
            containerId: 'crt_aptATFM_MM_24',
            dataSourceUrl: 'https://docs.google.com/spreadsheets/d/1E1UA1llpE7VJFcM5H1oOpAVLXbFE6LeIpyzuALkJyTQ/edit?usp=sharing&sheet=APT_ATFM_SES_MM&range=A5:F77&tq=where%20F%3D1',
            options: {
                width: 450,
                height: 190,
                chartArea: {

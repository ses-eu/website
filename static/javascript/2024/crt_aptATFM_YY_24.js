(function() {
  ...
  var crt_aptATFMsesYY = new google.visualization.ChartWrapper({
    ...
    containerId: 'crt_aptATFM_YY_24',
    dataSourceUrl: 'https://docs.google.com/spreadsheets/d/1uvYF8IlJE2HiAajEUrwLW-yaGGTcqy6zovOuTF1UQgA/edit?usp=sharing&sheet=APT_ATFM_SES_YY&range=A5:D14',
    options: {
        width: 450,
        height: 190,
        chartArea: {

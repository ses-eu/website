(function() {
    function dv(){
     ...
     var crt_aptATFMsesYY = new google.visualization.ChartWrapper({
        ...
        containerId: 'crt_aptATFMsesYY_18',
        dataSourceUrl: 'https://docs.google.com/spreadsheets/d/1zGSfKcWwkWzntORgUrWG4n09VVtNG3cWQtKNViwiAwk/edit?usp=sharing&sheet=APT_ATFM_SES_YY&range=A5:D10',
        options: {
            width: 450,
            height: 190,
            chartArea: {

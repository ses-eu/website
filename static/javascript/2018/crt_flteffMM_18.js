(function() {
 ...
 var crt_flteffMM = new google.visualization.ChartWrapper({
    chartType: 'LineChart',
    containerId: 'crt_flteffMM_18',
    dataSourceUrl: 'https://docs.google.com/spreadsheets/d/1AjwaFO1aKvKH0voqXWxx6GHTLOTwMqlkEzjLYFyet4Q/edit?usp=sharing&sheet=FLT_EFF_MM&range=A5:F65&tq=where%20F%3D1',
    options: {
        width: 450,
        height: 190,
        chartArea: {

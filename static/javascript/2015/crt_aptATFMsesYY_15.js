(function() {
	...
	var crt_aptATFMsesYY = new google.visualization.ChartWrapper({
		...
		containerId: 'crt_aptATFMsesYY_15',
		dataSourceUrl: '//docs.google.com/spreadsheets/d/1zVVd9DxxtVzExBuFLxZiDw7LTD65LDnd1CPaF3kN3HM/edit?usp=sharing&sheet=APT_ATFM_SES_YY&range=A5:D10',
		options:{
		...
		view: { columns: [0,1] , rows: [0,1,2,3,4] }

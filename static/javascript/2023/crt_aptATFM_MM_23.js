(function () {
    function dv() {
        ...
        var crt_aptATFMsesMM = new google.visualization.ChartWrapper({
            ...
            dataSourceUrl: 'https://docs.google.com/spreadsheets/d/14cwbCYNlJm23UXD08VW3ZoI4ghCg61k7jD0UOTSTwpk/edit?usp=sharing&sheet=APT_ATFM_SES_MM&range=A5:F77&tq=where%20F%3D1',
            options: {
                width: 450,
                height: 190,
                chartArea: {

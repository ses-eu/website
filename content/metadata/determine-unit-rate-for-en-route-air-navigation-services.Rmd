...
the [EU wide targets](../eu-wide-targets/). The cost efficiency KPI for the first reference period is the Determined Unit Rate for en route Air Navigation Services.
...
The calculation of the KPI is based on the [Filed Tactical Flight Model (FTFM)][ftfm] which corresponds to the last filed flight plan (see also [Horizontal flight efficiency calculations][hfe-meth]). 

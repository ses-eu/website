   ...
   <!-- Additional taxi-out time-->
    ...
    <!-- Share of arrivals applying CDO -->
        <table style="width: 950px;" border="0" cellpadding="1" cellspacing="1">
          ...
          <tr>
          <td colspan="4" rowspan="1" style="width: 950px"><div><span style="color:#C0504D;"><small>Data for September 2021 will only be available as of November 2021. This section will be updated as soon as the data is available.</span></div></small></td>
          </tr>
    <!--  <tr>

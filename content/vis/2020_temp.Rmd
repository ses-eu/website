...
<table style="text-align: left; width: 950px;" border="0" cellpadding="2" cellspacing="2">
 ...
 <!-- Use of share airspace etc -->
        <table style="width: 950px;" border="0" cellpadding="1" cellspacing="1">
          ...
          <tr>
            <td colspan="4" rowspan="1"><div class="head3">&nbsp; EnvironmentE PI #8: Rate of using available airspace structures (reserved or segregated and CDRs)</div><span style="color:#C0504D;"></span></td>
          </tr>
          <tr>
            <td colspan="4" rowspan="1" style="width: 950px"><div><span style="color:#C0504D;"><small>Data not yet available. The section will be updated as soon as the data is available.</span></div></small></td>
          </tr>
    ...
    <tr>
      ...
      <!-- EN-ROUTE ATFM DELAYS-->
       <table style="width: 950px;" border="0" cellpadding="1" cellspacing="1">
          ...
          <tr>
            <td colspan="2" rowspan="1" style="width: 475px; vertical-align: top;">
                <div style="float: left;" id="crt_ertdlyYY_20"></div>
                <div style="float: left;" id="tbl_ertdly_FAB_20"></div></td>
            <td colspan="2" rowspan="1" style="width: 475px; vertical-align: top;">
                <div style="float: left;" id="crt_ertdlyMM_20"></div>
                <div style="float: top;" id="tbl_ertdly_LOC_20"></div></td>
          </tr>
          </tbody>
        </table>  <br>
      <!-- AIRPORT ATFM ARRIVAL DELAYS-->
        <table style="width: 950px;" border="0" cellpadding="1" cellspacing="1">
          ...
          <tr>
            <td colspan="2" rowspan="1" style="width: 475px; vertical-align: top;">
                <div style="float: left;" id="crt_aptATFM_YY_20"></div>
                <div style="float: left;" id="tbl_aptATFM_LOC_20"></div></td>
            <td colspan="2" rowspan="1" style="width: 475px; vertical-align: top;">
                <div style="float: left;" id="crt_aptATFM_MM_20"></div>
                <div style="float: top;" id="tbl_aptATFM_APT_20"></div></td>
          </tr>
          </tbody>
        </table>
    <br>
  ...
  <br>
    <!-- ATC PRE DEPARTURE DELAYS--> 
      <table style="width: 950px;" border="0" cellpadding="1" cellspacing="1">
        <tbody>
        <tr>
          <td colspan="4" rowspan="1"><div class="head3">&nbsp; Capacity CPI #3: Air traffic control pre-departure delay [min. per dep.] <br>&nbsp; &nbsp;Capacity CPI #4: Average time of all cause-departure delay per flight [min. per dep.] </div></td>
        </tr>
        <tr>
          <td><div style="width: 350px; text-align: left; background-color:#f7f8f9; vertical-align: top;" class="data-period"> <span style="color:#C0504D;">Period: January-February</span></div></td>

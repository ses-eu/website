  ...
  <tr>
    ...
    <!-- Horizontal en-route flight efficiency-->
      <table style="width: 950px;" border="0" cellpadding="1" cellspacing="1">
        ...
        <tr>
          <td><div style="width: 350px; text-align: left; background-color:#f7f8f9; vertical-align: top;" class="data-period"> <span style="color:#C0504D;">Ref. date: 30. April</span></div></td>

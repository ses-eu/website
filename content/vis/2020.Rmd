...
<small><span style="color:#C0504D;">Last update: 15 Jul. 2021</small></span>
  ...
  <tr>
   ...
   <!-- EN-ROUTE SERVICE UNITS-->
    ...
    <!-- DETERMINED UNIT COSTS FOR EN ROUTE ANS-->
       ...
       <tbody>
            <tr>
              <td colspan="4" rowspan="1"><div class="head3">&nbsp; Cost efficiency KPI #1: Determined unit cost (DUC) for en-route (ER) ANS</div><span style="color:#C0504D;"><small>The combined 2020 and 2021 cost data is available on the</small></span><a href='{{< relref "/vis/2021.Rmd" >}}' target="_blank"> 2021 Dashboard</a></td>
            </tr>
      </tbody>
     </table>
     <!-- DETERMINED UNIT COSTS FOR TERMINAL ANS-->
       <table style="text-align: left; width: 950px;" border="0" cellpadding="2" cellspacing="2">
            <tbody>
            <tr>
              <td colspan="4" rowspan="1"><div class="head3">&nbsp; Cost efficiency KPI #2: Determined unit cost (DUC) for terminal (TR) ANS</div><span style="color:#C0504D;"><small> The combined 2020 and 2021 cost data is available on the</small></span><a href='{{< relref "/vis/2021.Rmd" >}}' target="_blank"> 2021 Dashboard</a></td>
            </tr>
        </tbody>
      </table>
  </tbody>
